...
3. Check in with the team every week, even if you only have part of the team
...
3. Do it again... and again...until it's a weekly habit.
...
Whatever our confidence vote, it's critical to then ask the team what things we can do to improve our confidence in the next week. **The _team_ is in the best position to decide what to do next.** Not some external stake-holder or advisor, but the team. Quickly brainstorm options and pick one or two which can be owned by a team member. 

Write them down and do them this week.
...
Setting goals is hard, making them measurable, checking in using confidence, brainstorming ideas to improve complex problems and performing those actions in less than a week before doing it all over again (in under 15 minutes) is hard. Giving up is easier. Giving up usually leads teams to conclude that OKRs don't offer real value. I've seen teams jump to this conclusion and stop checking-in, and I've seen teams set ambitious OKRs,  check in when it felt awkward and dumb, and keep checking-in and sharing results, until they get to a point where the check-ins are a vital tool for staying in synch, identifying issues, brainstorming and taking ownership of solutions, and enabling them to deliver outcomes that seemed impossible.
